...
const initialState = {
  header: {
    ...
    catalog: [
      {
        icon: "sistemi_kondicionirovaniya.png",
        name: "Кондиционеры и увлажнители",
        id: 1,
        subCategories: [
          {
            name: "Другие системы и аксессуары",
            id: 29,
            subCategories: [
              { name: "Аксессуары", id: 18 },
              { name: "Компрессорно - конденсаторные блоки", id: 30 },
              { name: "Крышные кондиционеры", id: 31 },
            ],
          },
          {
            name: "Чиллеры и Фанкойлы",
            id: 15,
            subCategories: [
              { name: "Чиллеры", id: 16 },
              { name: "Фанкойлы", id: 17 },
          ...
          {
            name: "VRV и VRF Мультизональные кондиционеры",
            id: 12,
            subCategories: [
              { name: "Внутренние блоки VRV и VRF системы", id: 14 },
              { name: "Наружные блоки VRV и VRF системы", id: 13 },
            ],
          },
          {
            ...
            id: 7,
            subCategories: [
              { name: "Кассетные кондиционеры", id: 8 },
              { name: "Канальные кондиционеры", id: 9 },
              { name: "Колонные кондиционеры", id: 10 },
              { name: "Напольно-потолочные кондиционеры", id: 11 },
            ],
          },
          {
            ...
            id: 3,
            subCategories: [
              { name: "Мультисплит-системы (комплект настенего типа)", id: 4 },
              { name: "Мультисплит-системы (наружные блоки)", id: 5 },
              { name: "Мультисплит-системы (внутренние блоки)", id: 6 },
            ],
          },
          {
            name: "Бытовые кондиционеры и увлажнители воздуха",
            id: 26,
            subCategories: [
              { name: "Увлажнители и очистители воздуха", id: 33 },
              { name: "Настенные кондиционеры (сплит-системы)", id: 2 },
              { name: "Мобильные Кондиционеры", id: 28 },
              { name: "Оконные кондиционеры", id: 27 },
            ],
          },
        ],
      },
      {
        icon: "sistemi_ventilyacii.png",
        ...
        subCategories: [
          {
            ...
            id: 34,
            subCategories: [
              { name: "Приточные система вентиляции", id: 35 },
              { name: "Приточно-вытяжная система вентиляции", id: 36 },
              { name: "Компактные приточные система вентиляции", id: 37 },
              { name: "Приточные клапана", id: 38 },
            ],
          },
          {
            name: "Вентиляторы",
            id: 39,
            subCategories: [
              { name: "Бытовые вентиляторы", id: 40 },
              { name: "Канальные вентиляторы", id: 41 },
              { name: "Вентиляторы радиальные", id: 42 },
              { name: "Крышные вентиляторы", id: 43 },
            ],
          },
          {
            name: "Воздуховоды",
            id: 44,
            subCategories: [
              { name: "Гибкие воздуховоды", id: 45 },
              { name: "Круглые воздуховоды из оцинкованной стали", id: 46 },
              {
                name: "Прямоугольные воздуховоды из оцинкованной стали",
                id: 47,
              },
              { name: "Фасонные части из оцинкованной стали", id: 48 },
            ],
          },
          {
            ...
            id: 49,
            subCategories: [
              { name: "Решетки прямоугольные", id: 50 },
              { name: "Решетки круглые", id: 51 },
              { name: "Адаптеры для вентиляционных решеток", id: 52 },
            ],
          },
          {
            name: "Канальные нагреватели",
            id: 53,
            subCategories: [
              { name: "Канальные нагреватели электрические", id: 54 },
              { name: "Канальные нагреватели водяные", id: 55 },
            ],
          },
          {
            ...
            id: 56,
            subCategories: [
              { name: "Воздушные фильтры", id: 57 },
              { name: "Шумоглушители", id: 58 },
              { name: "Гибкие вставки", id: 59 },
              { name: "Обратные клапана", id: 60 },
              { name: "Дроссель-клапана", id: 61 },
              { name: "Противопожарные клапана", id: 62 },
              { name: "Люки", id: 63 },
            ],
          },
          {
            ...
            id: 64,
            subCategories: [
              { name: "Регуляторы скорости для вентиляторов", id: 65 },
              { name: "Трансформаторные регуляторы скорости", id: 66 },
              { name: "Регуляторы температуры", id: 67 },
              { name: "Частотные преобразователи", id: 68 },
              { name: "Готовые шкафы и щиты автоматики вентиляции", id: 69 },
              { name: "Датчики", id: 70 },
              { name: "Электроприводы", id: 71 },
            ],
          },
        ],
      },
      {
        icon: "xolodilnoe-obarudivanie.png",
        name: "Холодильное оборудование",
        id: 23,
        subCategories: [
          {
            name: "Промышленный холод",
            id: 72,
            subCategories: [
              { name: "Камеры холодильные", id: 73 },
              { name: "Холодильные моноблоки", id: 74 },
              { name: "Холодильные сплит-системы", id: 75 },
              { name: "Холодильный воздухоохладитель", id: 76 },
              { name: "Конденсатор для холодильного оборудования", id: 77 },
              { name: "Холодильные компрессоры", id: 78 },
              { name: "Холодильные агрегаты", id: 79 },
              { name: "Вентиляторы промышленные", id: 80 },
              { name: "Щиты управления", id: 81 },
              { name: "Камеры газации бананов", id: 122 },
            ],
          },
          {
            name: "Холодильные витрины с выносным агрегатом",
            id: 82,
            subCategories: [
              { name: "Витрины холодильные", id: 83 },
              { name: "Пристенные горки", id: 84 },
              { name: "Бонеты", id: 89 },
            ],
          },
          {
            ...
            subCategories: [
              { name: "Бонеты", id: 85 },
              { name: "Витрины холодильные", id: 87 },
              { name: "Пристенные горки", id: 88 },
              { name: "Холодильные шкафы", id: 90 },
            ],
          },
        ],
      },
      {
        icon: "obogrevateli-kamini.png",
        name: "Обогреватели и камины",
        id: 24,
        subCategories: [
          {
            name: "Масляные радиаторы и конвекторы",
            id: 91,
            subCategories: [
              { name: "Масляные радиаторы", id: 92 },
              { name: "Конвекторы электрические", id: 93 },
            ],
          },
          {
            name: "Инфракрасные обогреватели и камины",
            id: 94,
            subCategories: [
              { name: "Инфракрасные обогреватели", id: 95 },
              { name: "Газовые инфракрасные обогреватели", id: 96 },
              { name: "Камины и печи", id: 97 },
            ],
          },
          {
            name: "Тепловентилаторы и Тепловые пушки",
            id: 98,
            subCategories: [
              { name: "Тепловентиляторы", id: 99 },
              { name: "Тепловые завесы", id: 100 },
              { name: "Водяные тепловентиляторы", id: 101 },
              { name: "Тепловые пушки", id: 102 },
            ],
          },
          {
            name: "Теплые полы и сушилки",
            id: 103,
            subCategories: [
              { name: "Теплые полы", id: 104 },
              { name: "Регуляторы и датчики", id: 105 },
              { name: "Сушилки для рук", id: 106 },
            ],
          },
        ],
      },
      {
        icon: "otopleniya-vodosnabjeniya.png",
        ...
        subCategories: [
          {
            ...
            id: 107,
            subCategories: [
              { name: "Водонагреватели и колонки", id: 108 },
              { name: "Бойлеры косвенного нагрева", id: 109 },
              { name: "Котлы отопления", id: 110 },
            ],
          },
          {
            name: "Насосы и расширительные баки",
            id: 111,
            subCategories: [
              { name: "Насосы", id: 112 },
              { name: "Гидроаккумуляторы", id: 113 },
              { name: "Расширительные баки", id: 114 },
            ],
          },
          {
            name: "Радиаторы и солнечные коллекторы",
            id: 115,
            subCategories: [
              { name: "Радиаторы отопления", id: 116 },
              { name: "Солнечные коллекторы", id: 117 },
            ],
          },
          {
            ...
            subCategories: [
              { name: "Трубы", id: 119 },
              { name: "Узлы и коллекторы", id: 120 },
              { name: "Шкафы коллекторные", id: 121 },
            ],
          },
        ],
      },
